...
namespace Terminal
{
    public class Terminalv3 : MonoBehaviour
    {
        ...
        public DirectoryAndFiles.Directory rootDirectory; // Root directory
        public DirectoryAndFiles.Directory currentDirectory; // Current working directory
        public DirectoryAndFiles.Directory previousDirectory; // Previous directory
        ...
        public void CreateDirectory(string directoryName)
        {
            ...
            {
                currentDirectory.Subdirectories[directoryName] = new DirectoryAndFiles.Directory(directoryName, currentDirectory);
        ...
        public void TouchCommand()
        {
            ...
            currentDirectory.Files[inputArray[1]] = new DirectoryAndFiles.Files(inputArray[1], fileContent);
        }
        ...
        {
            currentPath = "/";
            rootDirectory = new DirectoryAndFiles.Directory(currentPath);
            currentDirectory = rootDirectory;
            previousDirectory = rootDirectory;

            rootDirectory.Subdirectories["Home"] = new DirectoryAndFiles.Directory("Home", rootDirectory);
            rootDirectory.Subdirectories["Home"].Files["file1"] = new DirectoryAndFiles.Files("file1", "This is file1.");
        }
